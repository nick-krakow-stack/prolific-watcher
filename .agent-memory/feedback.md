...
- Owner requested transferring the useful `supplement-stack` Codex hook and memory workflow to this project.
- Owner explicitly excluded Cloudflare push/deploy rules because this repository only uses GitHub.
- Owner clarified that other AIs do not work on this project, so multi-KI rules are unnecessary.
